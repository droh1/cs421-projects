...
//#include <linux/hashtable.h> //To get hashtable
...
/*
* Added for project 2 but then moved to common.c
*/
...
/*typedef struct sysTable{ //Hash table for systemcalls
	...
	unsigned long count;
	struct hlist_node hash_list; //Linker
} sysTable;

//Array for blocking the potential 0-436 syscalls
sysTable *permList[436]; 
void initalizeHash(void);

//Getter for array
sysTable getTableMain(int pid){
	return *permList[pid];
}
//------------------------------------------------------------------
